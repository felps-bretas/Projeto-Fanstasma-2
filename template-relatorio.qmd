...
O banco de dados foi coletado pelo próprio cliente, possuindo uma boa amostra para fins de estudo contendo um total de 9 variáveis e 10.015 observações presentes para a confecção da análise, possuindo variáveis tanto qualitativas, discretas e contínuas, quanto quantitivas, nominais e ordinais.
