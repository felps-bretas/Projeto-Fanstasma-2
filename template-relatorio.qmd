...
Este relatório tem como objetivo um estudo mais aprofundado, por meio de análises descritivas, sendo utilizado diversos gráficos, tabelas e quadros, sendo também analisadas suas correlações, sobre a performance de atletas nas Olimpíadas dos anos 2000 até 2016, a fim de entender melhor o desempenho e possíveis relações desses atletas de elite da academia de alta performance “House of Excellence”.

O banco de dados foi coletado pelo próprio cliente, possuindo uma boa amostra para fins de estudo contendo um total de 9 variáveis para a confecção da análise, possuindo variáveis tanto qualitativas, discretas e contínuas, quanto quantitivas, nominais e ordinais.
...
Como pode ser observado pela @fig-3, os Estados Unidos possui o maior número de medalhas quanto se trata de atletas femininas, com um total de 741, representando 16,1% no total de medalhistas mulheres das Olimpíadas de 2000 até 2016, havendo uma diferença de 7,1% para o segundo colocado Rússia.
...
O Índice de Massa Corporal, mais conhecido como IMC, é uma medida internacional adotada para verificar se uma pessoa estaria numa certa faixa de "peso ideal". Esse índice varia por diversos aspectos e, entre um deles, está se a pessoa pratica ou não algum esporte.

Para está análise, foram utilizadas as váriaveis: "Altura (m)" (quantitativa contínua), "Peso (kg)" (quantitativa contínua) e "Esporte" (qualitativa nominal), significando respectivamente: altura de cada atleta participante em centímetros; peso de cada atleta em quilogramas; esporte que o competidor participou.

A fim de tentar compreender melhor essa relação, foi feita uma análise descritiva entre alguns dos esportes olímpicos e seus atletas, demonstrado pela figura e quadro abaixo:
...
Como pode ser observado pela @fig-4, os atletas de ginástica são os que apresentam menor mediana em relação aos outros esportes. Uma explicação para esse motivo se dá pelo fato dos atletas de ginástica precisarem muito de sua mobilidade e agilidade para executarem suas acrobacias, necessitando de uma menor taxa de IMC para facilitar os movimentos.

Algo que também vale a pena ser observado é o grande número de outliers nos competidores de atletismo, evidenciando a diversidade possível para os atletas entrarem em suas competições. Porém, mesmo com essa grande presença desse outliers, ainda apresentam a segunda menor mediana de IMC por atletas por esporte.

Como pode ser observado pelo quadro acima, a média entre os atletas de atletismo, badminton e futebol são bastante parecidas, todas em um pouco acima de 22. Algo que também vale a pena ser ressaltado é a grande variabilidade presente entre os atletas de atletismo e principalmente os de judô, os quais possuem um desvio padrão respectivamente de 3,86 e 5,12. Isso pode ser explicado pela grande diversidade de modalidades que englobam o atletismo e a diferença entre as categorias presentes no judô.
...
Como pode ser visto nesse relatório, para um país se tornar bastante vencedor em diversos esportes nas Olimpíadas, vários fatores devem ser levados em questão, como peso, altura e até a idade impactam no desempenho. Porém, somente esforço e talento dos atletas não são suficentes para se tornar campeão de determinado esporte, deve-se também ser acompanhado de um grande investimento em saúde, academia, psicólogo e diversos outros fatores importantes.

Todos esses quesitos podem ser observados pelos países presentes na @fig-3, que mesmo possuindo excelentes atletas, o investimento na área é pesado, assegurando não somente uma boa qualidade de vida para eles, mas também um futuro dentro do esporte.

Graças as Olimpíadas, esse estudo também mostra a grande variedade de competidores que participaram das competições de 2000 até 2016, apresentando uma grande variedade em todos os aspectos analisados.
